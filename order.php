                  ...
                  <div class="aa-order-summary-area">
                    <table class="table table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <input type="hidden" name="" value="<?= $id_product =  $row['id_product']; ?> ">
                          <td>  
                          ...
                          echo $title;
                           ...
                           ?>
                              ...
                              <td> <?php echo $row['status']; ?> </td>
                                ...
                                <td>    
                                             <a href="viewresult.php?id_order=<?php echo $row['id_order']; ?>">      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">

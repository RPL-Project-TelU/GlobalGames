...
if( isset($_POST['checkout'])){
  ...
  if( checkout($_POST) > 0 )  {
    echo "<script>
          ...
          document.location.href = 'invoice.php?id_product=$id_product';
...
<table class ="table table-dark" >
  ...
  <tbody>
    ...
    <tr>
    <th></th>
      <th scope="col"><textarea disabled style="width: 1000px; height: 200px;"><?= $description ?></textarea></>
    </tr>
  </tbody>
</table>
</div>
...
<button name="checkout" class="btn btn-success btn-lg" style="width: 150px; height: 45px; font-size: 20px; " role="button">BUY NOW</button>
 <?php } ?>
    <?php if ($_SESSION['balance_avail'] <= $price) { ?>
    <a href="topup.php" class="btn btn-danger btn-lg" style="width: 150px; height: 45px; font-size: 20px;" role="button">Reload Balance</a>  &nbsp;  &nbsp;<button class="btn btn-success btn-lg"  role="button" disabled>BUY</button><br> <a style="color: red;">*you balance is not enough<a>
       <?php } ?>
       <?php } ?>
   

  <?php if ($amount <= 0 ) { ?>
    <a class="btn btn-danger btn-lg" style="width: 150px; height: 45px; font-size: 20px;" role="button" disabled>Sold</a> 
    <?php } ?>
